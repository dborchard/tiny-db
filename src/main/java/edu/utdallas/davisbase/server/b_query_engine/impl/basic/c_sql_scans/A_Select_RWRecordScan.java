package edu.utdallas.davisbase.server.b_query_engine.impl.basic.c_sql_scans;

import edu.utdallas.davisbase.server.a_frontend.common.domain.clause.A_Predicate;
import edu.utdallas.davisbase.server.a_frontend.common.domain.clause.D_Constant;
import edu.utdallas.davisbase.server.a_frontend.common.domain.commands.ModifyData;
...
public class A_Select_RWRecordScan implements RWRecordScan {
   ...
   * Usage
   * {@link
   * edu.utdallas.davisbase.server.b_query_engine.impl.basic.a_query_optimizer.planner.b_rule_base.BetterUpdatePlanner#executeModify(ModifyData,
   * Transaction)}
   */
