...
public class B_SimpleTable extends AbstractTable implements ScannableTable {//, ModifiableTable {
  ...
  public B_SimpleTable(String tableName, List<String> fieldNames, List<SqlTypeName> fieldTypes,
