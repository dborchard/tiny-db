package edu.utdallas.davisbase.b1_metadata.index;
...
import edu.utdallas.davisbase.b1_metadata.table.TableMgr;
import edu.utdallas.davisbase.f_tx.Transaction;

import java.util.HashMap;
import java.util.Map;

import static edu.utdallas.davisbase.b1_metadata.table.TableMgr.MAX_NAME;
